...
VERSION=
commit=false
url=https://github.com/masternode/mastercoin
proc=2
mem=2000
lxc=true
docker=false
...
Run this script from the directory containing the mastercoin, gitian-builder, gitian.sigs, and mastercoin-detached-sigs.
...
-u|--url	Specify the URL of the repository. Default is https://github.com/masternode/mastercoin
