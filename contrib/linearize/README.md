# Linearize
Construct a linear, no-fork, best version of the Mastercoin blockchain. The scripts
run using Python 3 but are compatible with Python 2.

## Step 0: Install mastercoin_hash

https://github.com/masternode/mastercoin_hash
...
JSON-RPC server. Running `mastercoind` or `mastercoin-qt -server` will be sufficient.
...
* `input`: mastercoind blocks/ directory containing blkNNNNN.dat
