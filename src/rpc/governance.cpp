...
//#define ENABLE_MASTERCOIN_DEBUG
...
UniValue gobject(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp  ||
        ...
        throw std::runtime_error(
                ...
                "  vote-conf          - Vote on a governance object by masternode configured in mastercoin.conf\n"
    ...
    */
    ...
    if(strCommand == "vote-conf")
    {
        ...
        if(!fMnFound) {
            ...
            resultsObj.push_back(Pair("mastercoin.conf", statusObj));
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    /* Mastercoin features */
    { "mastercoin",               "getgovernanceinfo",      &getgovernanceinfo,      true,  {} },
    { "mastercoin",               "getsuperblockbudget",    &getsuperblockbudget,    true,  {"index"} },
    { "mastercoin",               "gobject",                &gobject,                true,  {} },
    { "mastercoin",               "voteraw",                &voteraw,                true,  {} },
