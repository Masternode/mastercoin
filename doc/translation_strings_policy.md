...
This document provides guidelines for internationalization of the Mastercoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `mastercoin_en.ts` remains unchanged.
