...
### Send 1000 MASTERCOIN to New Addresses

Send exactly 1000 MASTERCOIN to each new address created above.
...
Copy the masternode private key and correspondig collateral output transaction that holds the 1000 MASTERCOIN.

*Note: The masternode priviate key is **not** the same as a wallet private key. **Never** put your wallet private key in the masternode.conf file. That is almost equivalent to putting your 1000 MASTERCOIN on the remote server and defeats the purpose of a hot/cold setup.*
...
[From the mastercoin github repo](https://github.com/masternode/mastercoin/blob/master/doc/masternode_conf.md)
...
## Update mastercoin.conf on server

If you generated a new masternode private key, you will need to update the remote `mastercoin.conf` files.
...
```mastercoin-cli getinfo```

and comparing with the official explorer at https://explorer.mastercoin.org/chain/Mastercoin
...
mastercoin-cli masternode status
{
    ...
    "pubkey" : "<1000 MASTERCOIN address>",
